# ARCHIVED / REDIRECT — story-label-taxonomy
...
**Process rules (former §2 / §7):** [`ingest-validation.md`](ingest-validation.md) — section **Label process rules (GPT-SSR-10)**.

**Full snapshot:** [`archive/story-label-taxonomy.v0.2.3.md`](archive/story-label-taxonomy.v0.2.3.md)

Do **not** treat this stub as a key table or vocabulary SSOT.
